...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=22&pause=1000&color=3B82F6&center=true&vCenter=true&width=600&lines=Building+scalable+web+%26+mobile+apps;Exploring+AI+in+healthcare+%26+smart+cities;Crafting+clean%2C+maintainable+code;Always+learning%2C+always+building" alt="Typing SVG" />
...
```mermaid
graph LR
    A[Learning] --> B[Frontend Mastery]
    A --> C[Backend Excellence]
    A --> D[AI Exploration]
    B --> E[Building Cool Stuff]
    C --> E
    D --> E
    E --> F[Shipping Products]
```
